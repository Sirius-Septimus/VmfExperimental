...
{
/**
 * @brief This mutator selects a random byte in the buffer and then flips the byte based on a randomly generated bitmask.
 */
class RadamsaFlipByteMutator: public MutatorModule, public RadamsaByteMutatorBase
{
    public:
